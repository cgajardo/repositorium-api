<?php
	...
	class User{
		...
		*/
		 ...
		 * return boolean
		 */
		public function isAdmin($repo_id){
			/**
			 * WARNING: on june 2012 admins where site wide, 
			 * in the future, this can change, so be carefull.
			 */
			return DAOFactory::getUsersDAO()->isAdmin($this->id);
